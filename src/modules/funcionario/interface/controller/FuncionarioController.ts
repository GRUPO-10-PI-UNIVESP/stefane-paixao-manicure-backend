...
export default class FuncionarioController {
  async funcionarioCreate(
    service: IFuncionarioCreateServiceInput,
    httpBody: any
  ): Promise<any> {
    try {
      const funcionario: Funcionario = await service.execute(
        new FuncionarioFactory().getInstance(httpBody)
      );
  ...
  async funcionarioUpdate(
    service: IFuncionarioUpdateServiceInput,
    httpBody: any,
    param: number
  ): Promise<any> {
    try {
      const funcionario = await service.execute(
        new FuncionarioFactory().getInstance(httpBody),
        param
      );
  ...
  async funcionarioDelete(
    service: IFuncionarioDeleteServiceInput,
    param: number
  ): Promise<any> {
    try {
  ...
  async funcionarioReadUnique(
    service: IFuncionarioReadServiceInput,
    param: number
  ): Promise<any> {
    try {
      const funcionario = await service.execute(param);
  ...
  async funcionarioReadUniqueByName(
    service: IFuncionarioReadServiceInput,
    param: string
  ): Promise<any> {
    try {
